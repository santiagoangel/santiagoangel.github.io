...
= Santiago Angel
Big Data Architect & Technical Lead, Banco Santander
...
*Mexico City & Queretaro (Mexico) · Full-time · since May 2017
...
*Mexico City & Queretaro (Mexico) · Full-time · April 2017 - May 2017

Design and development of technical architecture using big data technology.

Analysis of data sources from traditional systems.

Responsible for Spark based solutions to support data ingestion from client and business data from all group. 
...
itect & Technical Lead at Banco Santander
*Mexico City & Queretaro (Mexico) · Full-time · Since April 2017*
